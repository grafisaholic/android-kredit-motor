...
import com.example.a1fo_khabiburrokhman_kreditmotor.MainActivity;
...
//        return inflater.inflate(R.layout.fragment_home, container, false);
        ...
        Button btnPetugas = v.findViewById(R.id.btnPetugas);
        mainActivity = (MainActivity)getActivity();

        btnPetugas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getActivity(), PetugasActivity.class);
                startActivity(i);
            }
        });
